...
//	//댓글 번호로 댓글 조회
//	@GetMapping(value="/comment/{cid}", produces = {MediaType.APPLICATION_JSON_VALUE})
...
//	}
	...
	// 댓글 번호로 게시글 수정
	@PutMapping(value = "/modify/{cid}", produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<Comment> updateComment(@PathVariable("cid") int cid, Comment comment) {
		commentService.modify(cid, comment);
		return new ResponseEntity<Comment>(comment, HttpStatus.OK);
