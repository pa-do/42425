      ...
      <div class="middle">
        ...
        <div class="form-wrap">
          <div class="input-wrap">
            <input v-model="email" id="Memail" placeholder="이메일을 입력해주세요" type="text" />
            <button @click="checkEmail" class="mt-2 mx-3">이메일 체크</button>
          ...
          <div class="input-wrap password-wrap">
            <input v-model="password" id="Mpassword" type="password" placeholder="비밀번호를 입력해주세요" />
          </div>
        ...
        <button class="btn" @click="modifypw">
          <span>수정 완료</span>
        </button>
      </div>
    </div>
